...
_0x0:
	.DB  0x55,0x3D,0x20,0x0,0x52,0x50,0x4D,0x20
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 002E   itoa(counter,LCD_BUFER);
	ST   -Y,R5
	ST   -Y,R4
	LDI  R26,LOW(_LCD_BUFER)
	LDI  R27,HIGH(_LCD_BUFER)
	RCALL _itoa
...
; 0000 004D   Read_and_Display_RPM();
	RCALL _Read_and_Display_RPM
; 0000 004E 
; 0000 004F   Read_and_Display_Voltage();
	RCALL _Read_and_Display_Voltage
; 0000 0050 
